...
class ScheduleTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let sched1 = Schedule(name: "Caprese Salad1", classes: Classes)
        let sched2 = Schedule(name: "Caprese Salad2", classes: Classes)
        let sched3 = Schedule(name: "Caprese Salad3", classes: Classes)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //cell.nameLabel.text = sched.name
